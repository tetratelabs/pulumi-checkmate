module github.com/tetratelabs/pulumi-checkmate
...
require (
	...
	github.com/tetratelabs/terraform-provider-checkmate v0.1.0
)
...
require (
	...
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.34.1-0.20221214173921-8e65b1f9fdd5 // indirect
